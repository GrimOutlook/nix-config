...
let
  cfg = config.host.default-programs.documentation;
in
{
  options.host.default-programs.documentation.enable =
    lib.mkEnableOption "Enable documentation program configurations";
